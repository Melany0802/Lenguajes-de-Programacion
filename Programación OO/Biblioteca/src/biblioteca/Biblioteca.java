...
public class Biblioteca {
    ...
    public String toString() {
        ...
        sb.append("Nombre de la Biblioteca= '").append(nombre).append('\'');
        sb.append(", Nombre del Socios= ").append(socios);
        sb.append(", Nombre del Libros= ").append(libros);
        sb.append(", Nombre del Prestamos= ").append(prestamos);
        sb.append('}');
        return sb.toString();
    }
}