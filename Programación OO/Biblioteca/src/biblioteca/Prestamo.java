...
public class Prestamo {private int id_prestamo;
    ...
    public String toString() {
        ...
        sb.append("Id del Prestamo = ").append(id_prestamo);
        sb.append(", Id del Socio = ").append(id_socio);
        sb.append(", Código del Libro = ").append(codigo_libro);
